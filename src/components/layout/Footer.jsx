  ...
  return (
    <footer className="bg-secondary-dark text-slate-300 py-12 no-print">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Brand */}
        <div>
          <h3 className="text-white text-lg font-heading font-bold mb-4">Complexe WAB</h3>
          <p className="text-sm leading-relaxed">
            Votre destination d'exception à Douala : Gastronomie, Hébergement de standing et Événementiel de prestige.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/catalogue" className="hover:text-white transition-colors">Nos Services</Link></li>
